-- ============================================================================
-- COLORSHINE MES V2
-- 13_user_working_screens.sql
--
-- Purpose
--   Persist each user's currently open processing screens (working tabs).
--   Maximum 8 screens per user. Screens are referenced by screen_id so future
--   screen-number changes do not break a user's open-screen list.
--
-- Prerequisite
...
VALUES ('1.4.0','Per-user working screen tabs with maximum 8 open screens')
...
COMMENT ON TABLE mes.app_user_working_screen IS
'Currently open MES processing screens for a user. Maximum 8 per user. Rows remain until user closes the screen tab.';
...
WHERE table_schema='mes' AND table_name='app_user_working_screen';
