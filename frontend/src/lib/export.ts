...
export const inventoryMasterReportColumns = [
  ...
  ['Batch','batch_no'],
  ['Batch Qty (MT)','batch_qty_mt'],
  ['QA Grade','qa_grade'],
  ['Thickness (mm)','thickness_mm'],
  ['Width (mm)','width_mm'],
  ['Length (m)','length_value'],
  ['Temper','temper'],
  ['Coating','coating'],
  ['Jet Printing','jet_printing'],
  ['Stock Generated Date','stock_generated_date'],
  ['Stock Age (Days)','stock_age_days'],
  ['MES PO','mes_po'],
  ['SO No','so_no'],
  ['SO Line Item','so_line_item'],
  ['SO Thickness (mm)','so_thickness_mm'],
  ['SO Width (mm)','so_width_mm'],
  ['SO Temper','so_temper'],
  ['SO Quality','so_quality'],
  ['SO Coating','so_coating'],
  ['SO Min Wt (MT)','so_min_wt_mt'],
  ['SO Max Wt (MT)','so_max_wt_mt'],
  ['SO Logo','so_logo'],
  ...
  ['Mother Stock GRN Age (Days)','mother_stock_grn_age_days'],
...
const rmChemistryKeys=new Set(['carbon','manganese','sulphur','phosphorus','silicon','aluminium','carbon_equivalent','nitrogen','copper','chromium','nickel']);
