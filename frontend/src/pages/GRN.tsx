  ...
  return <>
    ...
    <div className="table-panel analysis-table-panel">
      ...
      {rows.map(r=><tr key={r.grn_coil_id}>
        ...
        <td>{r.batch_thickness_mm?num(r.batch_thickness_mm,3):'—'} mm</td>
        <td>{r.batch_width_mm?num(r.batch_width_mm,0):'—'} mm</td>
        <td><b>{num(r.batch_weight_mt)}</b> MT</td>
        <td><Status value={r.quality_status}/></td>
